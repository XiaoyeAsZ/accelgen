...
echo '========================================'
echo '[Group 1] Running: llama3-70b-block0-attention-decode-b8s4096'
echo '========================================'
./build/bin/accelgen-opt benchmark/mlir/llama3-70b-block0-attention-decode-b8s4096.mlir -pass-pipeline="model-baseline-accelerator{accelerator-name=gemmini_os_server ppu-name=PPU_server datamove-arch-name=PPU_datamove_server config-path=/home/accelgen/example_designs mlir-file=benchmark/mlir/llama3-70b-block0-attention-decode-b8s4096.mlir}" -o /dev/null 2>&1 | tee baseline_test_70b/logs/llama3-70b-block0-attention-decode-b8s4096_gemmini_os_server.log
exit_code=${PIPESTATUS[0]}
echo EXIT_CODE=${exit_code} >> baseline_test_70b/logs/llama3-70b-block0-attention-decode-b8s4096_gemmini_os_server.log
echo 'Group 1 done (1 tests)'
