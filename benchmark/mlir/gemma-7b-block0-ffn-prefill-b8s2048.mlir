...
module {
  func.func @main(%arg0: tensor<8x2048x3072xbf16>, %arg1: tensor<24576x3072xbf16>, %arg2: tensor<24576x3072xbf16>, %arg3: tensor<3072x24576xbf16>) -> tensor<8x2048x3072xbf16> {
    ...
    %3 = tensor.empty() : tensor<8x2048x24576xbf16>
    %4 = linalg.fill ins(%cst : bf16) outs(%3 : tensor<8x2048x24576xbf16>) -> tensor<8x2048x24576xbf16>
    %5 = linalg.batch_matmul ins(%arg0, %2 : tensor<8x2048x3072xbf16>, tensor<8x3072x24576xbf16>) outs(%4 : tensor<8x2048x24576xbf16>) -> tensor<8x2048x24576xbf16>
    %6 = linalg.generic {indexing_maps = [#map1, #map1], iterator_types = ["parallel", "parallel", "parallel"]} ins(%5 : tensor<8x2048x24576xbf16>) outs(%3 : tensor<8x2048x24576xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
    ...
    %8 = linalg.batch_matmul ins(%arg0, %7 : tensor<8x2048x3072xbf16>, tensor<8x3072x24576xbf16>) outs(%4 : tensor<8x2048x24576xbf16>) -> tensor<8x2048x24576xbf16>
    %9 = linalg.generic {indexing_maps = [#map1, #map1, #map1], iterator_types = ["parallel", "parallel", "parallel"]} ins(%6, %8 : tensor<8x2048x24576xbf16>, tensor<8x2048x24576xbf16>) outs(%3 : tensor<8x2048x24576xbf16>) {
    ...
    %13 = tensor.empty() : tensor<8x2048x3072xbf16>
    %14 = linalg.fill ins(%cst : bf16) outs(%13 : tensor<8x2048x3072xbf16>) -> tensor<8x2048x3072xbf16>
    %15 = linalg.batch_matmul ins(%9, %12 : tensor<8x2048x24576xbf16>, tensor<8x24576x3072xbf16>) outs(%14 : tensor<8x2048x3072xbf16>) -> tensor<8x2048x3072xbf16>
    return %15 : tensor<8x2048x3072xbf16>
  }
}
