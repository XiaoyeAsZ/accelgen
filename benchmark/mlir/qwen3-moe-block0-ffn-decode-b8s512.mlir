...
module {
  func.func @main(%arg0: tensor<8x1x4096xbf16>, %arg1: tensor<8x4096x24576xbf16>, %arg2: tensor<8x12288x4096xbf16>, %arg3: tensor<16x16xbf16>, %arg4: tensor<128x4096xbf16>) -> (tensor<8x1x4096xbf16>, tensor<8x128xbf16>) {
    ...
    %27 = linalg.batch_matmul ins(%arg0, %arg1 : tensor<8x1x4096xbf16>, tensor<8x4096x24576xbf16>) outs(%26 : tensor<8x1x24576xf32>) -> tensor<8x1x24576xf32>
    ...
    %expanded_7 = tensor.expand_shape %29 [[0], [1], [2, 3]] output_shape [8, 1, 8, 3072] : tensor<8x1x24576xbf16> into tensor<8x1x8x3072xbf16>
    ...
    %31 = linalg.generic {indexing_maps = [#map1, #map1], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%extracted_slice_8 : tensor<8x1x8x1536xbf16>) outs(%30 : tensor<8x1x8x1536xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
    ...
    %32 = linalg.generic {indexing_maps = [#map1, #map1, #map1], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%31, %extracted_slice_8 : tensor<8x1x8x1536xbf16>, tensor<8x1x8x1536xbf16>) outs(%30 : tensor<8x1x8x1536xbf16>) {
    ^bb0(%in: bf16, %in_12: bf16, %out: bf16):
      %40 = arith.mulf %in, %in_12 : bf16
      linalg.yield %40 : bf16
    } -> tensor<8x1x8x1536xbf16>
    %33 = linalg.generic {indexing_maps = [#map1, #map1, #map1], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%32, %extracted_slice_9 : tensor<8x1x8x1536xbf16>, tensor<8x1x8x1536xbf16>) outs(%30 : tensor<8x1x8x1536xbf16>) {
    ^bb0(%in: bf16, %in_12: bf16, %out: bf16):
      %40 = arith.mulf %in, %in_12 : bf16
      linalg.yield %40 : bf16
    } -> tensor<8x1x8x1536xbf16>
    %expanded_10 = tensor.expand_shape %24 [[0], [1], [2, 3]] output_shape [8, 1, 8, 1] : tensor<8x1x8xbf16> into tensor<8x1x8x1xbf16>
    %34 = linalg.generic {indexing_maps = [#map1, #map2, #map1], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%33, %expanded_10 : tensor<8x1x8x1536xbf16>, tensor<8x1x8x1xbf16>) outs(%30 : tensor<8x1x8x1536xbf16>) {
    ^bb0(%in: bf16, %in_12: bf16, %out: bf16):
      %40 = arith.mulf %in, %in_12 : bf16
      linalg.yield %40 : bf16
    } -> tensor<8x1x8x1536xbf16>
    %collapsed_11 = tensor.collapse_shape %34 [[0], [1], [2, 3]] : tensor<8x1x8x1536xbf16> into tensor<8x1x12288xbf16>
    %35 = tensor.empty() : tensor<8x1x4096xf32>
    %36 = linalg.fill ins(%cst : f32) outs(%35 : tensor<8x1x4096xf32>) -> tensor<8x1x4096xf32>
    %37 = linalg.batch_matmul ins(%collapsed_11, %arg2 : tensor<8x1x12288xbf16>, tensor<8x12288x4096xbf16>) outs(%36 : tensor<8x1x4096xf32>) -> tensor<8x1x4096xf32>
