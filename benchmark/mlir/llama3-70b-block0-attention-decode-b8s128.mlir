...
module {
  func.func @main(%arg0: tensor<8x1x4096xbf16>, %arg1: tensor<1x1x128xbf16>, %arg2: tensor<1x1x128xbf16>, %arg3: tensor<1x32x1x1xbf16>, %arg4: tensor<8x32x127x128xbf16>, %arg5: tensor<8x32x127x128xbf16>, %arg6: tensor<4096x4096xbf16>, %arg7: tensor<4096x4096xbf16>, %arg8: tensor<4096x4096xbf16>, %arg9: tensor<4096x4096xbf16>) -> (tensor<8x1x4096xbf16>, tensor<8x32x1x128xbf16>) {
    ...
    %concat_16 = tensor.concat dim(2) %arg4, %20 : (tensor<8x32x127x128xbf16>, tensor<8x32x1x128xbf16>) -> tensor<8x32x128x128xbf16>
    %concat_17 = tensor.concat dim(2) %arg5, %transposed_9 : (tensor<8x32x127x128xbf16>, tensor<8x32x1x128xbf16>) -> tensor<8x32x128x128xbf16>
    %21 = tensor.empty() : tensor<8x32x128x128xbf16>
    %transposed_18 = linalg.transpose ins(%concat_16 : tensor<8x32x128x128xbf16>) outs(%21 : tensor<8x32x128x128xbf16>) permutation = [0, 1, 3, 2] 
    ...
    %collapsed_21 = tensor.collapse_shape %transposed_18 [[0, 1], [2], [3]] : tensor<8x32x128x128xbf16> into tensor<256x128x128xbf16>
    %23 = tensor.empty() : tensor<256x1x128xbf16>
    %24 = linalg.fill ins(%cst : bf16) outs(%23 : tensor<256x1x128xbf16>) -> tensor<256x1x128xbf16>
    %25 = linalg.batch_matmul ins(%collapsed_20, %collapsed_21 : tensor<256x1x128xbf16>, tensor<256x128x128xbf16>) outs(%24 : tensor<256x1x128xbf16>) -> tensor<256x1x128xbf16>
    %expanded_22 = tensor.expand_shape %25 [[0, 1], [2], [3]] output_shape [8, 32, 1, 128] : tensor<256x1x128xbf16> into tensor<8x32x1x128xbf16>
    %26 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%expanded_22 : tensor<8x32x1x128xbf16>) outs(%7 : tensor<8x32x1x128xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      %48 = arith.truncf %cst_2 : f64 to bf16
      %49 = arith.mulf %in, %48 : bf16
      linalg.yield %49 : bf16
    } -> tensor<8x32x1x128xbf16>
    %27 = linalg.generic {indexing_maps = [#map3, #map6, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%26, %arg3 : tensor<8x32x1x128xbf16>, tensor<1x32x1x1xbf16>) outs(%7 : tensor<8x32x1x128xbf16>) {
    ^bb0(%in: bf16, %in_31: bf16, %out: bf16):
      %48 = arith.addf %in, %in_31 : bf16
      linalg.yield %48 : bf16
    } -> tensor<8x32x1x128xbf16>
    %28 = tensor.empty() : tensor<8x32x1x128xf32>
    %29 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%27 : tensor<8x32x1x128xbf16>) outs(%28 : tensor<8x32x1x128xf32>) {
    ^bb0(%in: bf16, %out: f32):
      %48 = arith.extf %in : bf16 to f32
      linalg.yield %48 : f32
    } -> tensor<8x32x1x128xf32>
    %30 = tensor.empty() : tensor<8x32x1xi64>
    %31 = linalg.fill ins(%c0_i64 : i64) outs(%30 : tensor<8x32x1xi64>) -> tensor<8x32x1xi64>
    %32 = tensor.empty() : tensor<8x32x1xf32>
    %33 = linalg.fill ins(%cst_0 : f32) outs(%32 : tensor<8x32x1xf32>) -> tensor<8x32x1xf32>
    %34:2 = linalg.generic {indexing_maps = [#map3, #map7, #map7], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%29 : tensor<8x32x1x128xf32>) outs(%33, %31 : tensor<8x32x1xf32>, tensor<8x32x1xi64>) {
    ^bb0(%in: f32, %out: f32, %out_31: i64):
      %48 = linalg.index 3 : index
      %49 = arith.index_cast %48 : index to i64
      %50 = arith.maximumf %in, %out : f32
      %51 = arith.cmpf ogt, %in, %out : f32
      %52 = arith.select %51, %49, %out_31 : i64
      linalg.yield %50, %52 : f32, i64
    } -> (tensor<8x32x1xf32>, tensor<8x32x1xi64>)
    %expanded_23 = tensor.expand_shape %34#0 [[0], [1], [2, 3]] output_shape [8, 32, 1, 1] : tensor<8x32x1xf32> into tensor<8x32x1x1xf32>
    %35 = linalg.generic {indexing_maps = [#map3, #map8, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%29, %expanded_23 : tensor<8x32x1x128xf32>, tensor<8x32x1x1xf32>) outs(%28 : tensor<8x32x1x128xf32>) {
    ^bb0(%in: f32, %in_31: f32, %out: f32):
      %48 = arith.subf %in, %in_31 : f32
      linalg.yield %48 : f32
    } -> tensor<8x32x1x128xf32>
    %36 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%35 : tensor<8x32x1x128xf32>) outs(%28 : tensor<8x32x1x128xf32>) {
    ^bb0(%in: f32, %out: f32):
      %48 = math.exp %in : f32
      linalg.yield %48 : f32
    } -> tensor<8x32x1x128xf32>
    %37 = tensor.empty() : tensor<8x32x1x1xf32>
    %38 = linalg.fill ins(%cst_1 : f32) outs(%37 : tensor<8x32x1x1xf32>) -> tensor<8x32x1x1xf32>
    %39 = linalg.generic {indexing_maps = [#map3, #map8], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%36 : tensor<8x32x1x128xf32>) outs(%38 : tensor<8x32x1x1xf32>) {
    ^bb0(%in: f32, %out: f32):
      %48 = arith.addf %in, %out : f32
      linalg.yield %48 : f32
    } -> tensor<8x32x1x1xf32>
    %40 = linalg.generic {indexing_maps = [#map3, #map8, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%36, %39 : tensor<8x32x1x128xf32>, tensor<8x32x1x1xf32>) outs(%28 : tensor<8x32x1x128xf32>) {
    ^bb0(%in: f32, %in_31: f32, %out: f32):
      %48 = arith.divf %in, %in_31 : f32
      linalg.yield %48 : f32
    } -> tensor<8x32x1x128xf32>
    %41 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%40 : tensor<8x32x1x128xf32>) outs(%7 : tensor<8x32x1x128xbf16>) {
    ^bb0(%in: f32, %out: bf16):
      %48 = arith.truncf %in : f32 to bf16
      linalg.yield %48 : bf16
    } -> tensor<8x32x1x128xbf16>
    %collapsed_24 = tensor.collapse_shape %41 [[0], [1, 2], [3]] : tensor<8x32x1x128xbf16> into tensor<8x32x128xbf16>
    %42 = linalg.generic {indexing_maps = [#map5, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%collapsed_24 : tensor<8x32x128xbf16>) outs(%7 : tensor<8x32x1x128xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<8x32x1x128xbf16>
    %collapsed_25 = tensor.collapse_shape %42 [[0, 1], [2], [3]] : tensor<8x32x1x128xbf16> into tensor<256x1x128xbf16>
    %collapsed_26 = tensor.collapse_shape %concat_17 [[0, 1], [2], [3]] : tensor<8x32x128x128xbf16> into tensor<256x128x128xbf16>
    %43 = linalg.batch_matmul ins(%collapsed_25, %collapsed_26 : tensor<256x1x128xbf16>, tensor<256x128x128xbf16>) outs(%24 : tensor<256x1x128xbf16>) -> tensor<256x1x128xbf16>
    %expanded_27 = tensor.expand_shape %43 [[0, 1], [2], [3]] output_shape [8, 32, 1, 128] : tensor<256x1x128xbf16> into tensor<8x32x1x128xbf16>
    %44 = tensor.empty() : tensor<8x1x32x128xbf16>
    %transposed_28 = linalg.transpose ins(%expanded_27 : tensor<8x32x1x128xbf16>) outs(%44 : tensor<8x1x32x128xbf16>) permutation = [0, 2, 1, 3] 
    ...
    %45 = linalg.generic {indexing_maps = [#map, #map1], iterator_types = ["parallel", "parallel", "parallel"]} ins(%collapsed_30 : tensor<8x4096xbf16>) outs(%1 : tensor<8x1x4096xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<8x1x4096xbf16>
    %46 = linalg.generic {indexing_maps = [#map2, #map1], iterator_types = ["parallel", "parallel", "parallel"]} ins(%transposed_29 : tensor<4096x4096xbf16>) outs(%3 : tensor<8x4096x4096xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<8x4096x4096xbf16>
    %47 = linalg.batch_matmul ins(%45, %46 : tensor<8x1x4096xbf16>, tensor<8x4096x4096xbf16>) outs(%5 : tensor<8x1x4096xbf16>) -> tensor<8x1x4096xbf16>
    return %47, %41 : tensor<8x1x4096xbf16>, tensor<8x32x1x128xbf16>
  }
}
