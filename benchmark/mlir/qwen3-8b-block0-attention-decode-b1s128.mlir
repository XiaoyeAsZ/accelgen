...
module {
  func.func @main(%arg0: tensor<1x1x4096xbf16>, %arg1: tensor<1x1x128xbf16>, %arg2: tensor<1x1x128xbf16>, %arg3: tensor<1x32x1x1xbf16>, %arg4: tensor<1x8x127x128xbf16>, %arg5: tensor<1x8x127x128xbf16>, %arg6: tensor<4096x4096xbf16>, %arg7: tensor<1024x4096xbf16>, %arg8: tensor<1024x4096xbf16>, %arg9: tensor<4096x4096xbf16>, %arg10: tensor<128xbf16>, %arg11: tensor<128xbf16>) -> tensor<1x1x4096xbf16> {
    ...
    ^bb0(%in: f32, %out: f32):
      %84 = math.fpowi %in, %c2_i64 : f32, i64
      linalg.yield %84 : f32
    } -> tensor<1x1x32x128xf32>
    ...
    ^bb0(%in: f32, %out: f32):
      %84 = arith.truncf %cst_3 : f64 to f32
      %85 = arith.addf %in, %84 : f32
      linalg.yield %85 : f32
    } -> tensor<1x1x32x1xf32>
    ...
    ^bb0(%in: f32, %out: bf16):
      %84 = arith.truncf %in : f32 to bf16
    ...
    %concat_18 = tensor.concat dim(2) %arg4, %52 : (tensor<1x8x127x128xbf16>, tensor<1x8x1x128xbf16>) -> tensor<1x8x128x128xbf16>
    %concat_19 = tensor.concat dim(2) %arg5, %transposed_11 : (tensor<1x8x127x128xbf16>, tensor<1x8x1x128xbf16>) -> tensor<1x8x128x128xbf16>
    %53 = tensor.empty() : tensor<1x8x4x128x128xbf16>
    %54 = linalg.generic {indexing_maps = [#map7, #map8], iterator_types = ["parallel", "parallel", "parallel", "parallel", "parallel"]} ins(%concat_18 : tensor<1x8x128x128xbf16>) outs(%53 : tensor<1x8x4x128x128xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x8x4x128x128xbf16>
    %collapsed_20 = tensor.collapse_shape %54 [[0], [1, 2], [3], [4]] : tensor<1x8x4x128x128xbf16> into tensor<1x32x128x128xbf16>
    %55 = linalg.generic {indexing_maps = [#map7, #map8], iterator_types = ["parallel", "parallel", "parallel", "parallel", "parallel"]} ins(%concat_19 : tensor<1x8x128x128xbf16>) outs(%53 : tensor<1x8x4x128x128xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x8x4x128x128xbf16>
    %56 = tensor.empty() : tensor<1x32x128x128xbf16>
    %transposed_21 = linalg.transpose ins(%collapsed_20 : tensor<1x32x128x128xbf16>) outs(%56 : tensor<1x32x128x128xbf16>) permutation = [0, 1, 3, 2] 
    ...
    %collapsed_23 = tensor.collapse_shape %transposed_21 [[0, 1], [2], [3]] : tensor<1x32x128x128xbf16> into tensor<32x128x128xbf16>
    %58 = linalg.generic {indexing_maps = [#map10, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%collapsed_23 : tensor<32x128x128xbf16>) outs(%56 : tensor<1x32x128x128xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x32x128x128xbf16>
    %collapsed_24 = tensor.collapse_shape %57 [[0, 1], [2], [3]] : tensor<1x32x1x128xbf16> into tensor<32x1x128xbf16>
    %collapsed_25 = tensor.collapse_shape %58 [[0, 1], [2], [3]] : tensor<1x32x128x128xbf16> into tensor<32x128x128xbf16>
    %59 = tensor.empty() : tensor<32x1x128xbf16>
    %60 = linalg.fill ins(%cst : bf16) outs(%59 : tensor<32x1x128xbf16>) -> tensor<32x1x128xbf16>
    %61 = linalg.batch_matmul ins(%collapsed_24, %collapsed_25 : tensor<32x1x128xbf16>, tensor<32x128x128xbf16>) outs(%60 : tensor<32x1x128xbf16>) -> tensor<32x1x128xbf16>
    %expanded_26 = tensor.expand_shape %61 [[0, 1], [2], [3]] output_shape [1, 32, 1, 128] : tensor<32x1x128xbf16> into tensor<1x32x1x128xbf16>
    %62 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%expanded_26 : tensor<1x32x1x128xbf16>) outs(%20 : tensor<1x32x1x128xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      %84 = arith.truncf %cst_2 : f64 to bf16
      %85 = arith.mulf %in, %84 : bf16
      linalg.yield %85 : bf16
    } -> tensor<1x32x1x128xbf16>
    %63 = linalg.generic {indexing_maps = [#map3, #map4, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%62, %arg3 : tensor<1x32x1x128xbf16>, tensor<1x32x1x1xbf16>) outs(%20 : tensor<1x32x1x128xbf16>) {
    ^bb0(%in: bf16, %in_36: bf16, %out: bf16):
      %84 = arith.addf %in, %in_36 : bf16
      linalg.yield %84 : bf16
    } -> tensor<1x32x1x128xbf16>
    %64 = tensor.empty() : tensor<1x32x1x128xf32>
    %65 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%63 : tensor<1x32x1x128xbf16>) outs(%64 : tensor<1x32x1x128xf32>) {
    ^bb0(%in: bf16, %out: f32):
      %84 = arith.extf %in : bf16 to f32
      linalg.yield %84 : f32
    } -> tensor<1x32x1x128xf32>
    %66 = tensor.empty() : tensor<1x32x1xi64>
    %67 = linalg.fill ins(%c0_i64 : i64) outs(%66 : tensor<1x32x1xi64>) -> tensor<1x32x1xi64>
    %68 = tensor.empty() : tensor<1x32x1xf32>
    %69 = linalg.fill ins(%cst_1 : f32) outs(%68 : tensor<1x32x1xf32>) -> tensor<1x32x1xf32>
    %70:2 = linalg.generic {indexing_maps = [#map3, #map11, #map11], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%65 : tensor<1x32x1x128xf32>) outs(%69, %67 : tensor<1x32x1xf32>, tensor<1x32x1xi64>) {
    ^bb0(%in: f32, %out: f32, %out_36: i64):
      %84 = linalg.index 3 : index
      %85 = arith.index_cast %84 : index to i64
      %86 = arith.maximumf %in, %out : f32
      %87 = arith.cmpf ogt, %in, %out : f32
      %88 = arith.select %87, %85, %out_36 : i64
      linalg.yield %86, %88 : f32, i64
    } -> (tensor<1x32x1xf32>, tensor<1x32x1xi64>)
    %expanded_27 = tensor.expand_shape %70#0 [[0], [1], [2, 3]] output_shape [1, 32, 1, 1] : tensor<1x32x1xf32> into tensor<1x32x1x1xf32>
    %71 = linalg.generic {indexing_maps = [#map3, #map4, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%65, %expanded_27 : tensor<1x32x1x128xf32>, tensor<1x32x1x1xf32>) outs(%64 : tensor<1x32x1x128xf32>) {
    ^bb0(%in: f32, %in_36: f32, %out: f32):
      %84 = arith.subf %in, %in_36 : f32
      linalg.yield %84 : f32
    } -> tensor<1x32x1x128xf32>
    %72 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%71 : tensor<1x32x1x128xf32>) outs(%64 : tensor<1x32x1x128xf32>) {
    ^bb0(%in: f32, %out: f32):
      %84 = math.exp %in : f32
      linalg.yield %84 : f32
    } -> tensor<1x32x1x128xf32>
    %73 = tensor.empty() : tensor<1x32x1x1xf32>
    %74 = linalg.fill ins(%cst_0 : f32) outs(%73 : tensor<1x32x1x1xf32>) -> tensor<1x32x1x1xf32>
    %75 = linalg.generic {indexing_maps = [#map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%72 : tensor<1x32x1x128xf32>) outs(%74 : tensor<1x32x1x1xf32>) {
    ^bb0(%in: f32, %out: f32):
      %84 = arith.addf %in, %out : f32
      linalg.yield %84 : f32
    } -> tensor<1x32x1x1xf32>
    %76 = linalg.generic {indexing_maps = [#map3, #map4, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%72, %75 : tensor<1x32x1x128xf32>, tensor<1x32x1x1xf32>) outs(%64 : tensor<1x32x1x128xf32>) {
    ^bb0(%in: f32, %in_36: f32, %out: f32):
      %84 = arith.divf %in, %in_36 : f32
      linalg.yield %84 : f32
    } -> tensor<1x32x1x128xf32>
    %77 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%76 : tensor<1x32x1x128xf32>) outs(%20 : tensor<1x32x1x128xbf16>) {
    ^bb0(%in: f32, %out: bf16):
      %84 = arith.truncf %in : f32 to bf16
      linalg.yield %84 : bf16
    } -> tensor<1x32x1x128xbf16>
    %collapsed_28 = tensor.collapse_shape %77 [[0, 1, 2], [3]] : tensor<1x32x1x128xbf16> into tensor<32x128xbf16>
    %78 = linalg.generic {indexing_maps = [#map9, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%collapsed_28 : tensor<32x128xbf16>) outs(%20 : tensor<1x32x1x128xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x32x1x128xbf16>
    %collapsed_29 = tensor.collapse_shape %55 [[0, 1, 2], [3], [4]] : tensor<1x8x4x128x128xbf16> into tensor<32x128x128xbf16>
    %79 = linalg.generic {indexing_maps = [#map10, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%collapsed_29 : tensor<32x128x128xbf16>) outs(%56 : tensor<1x32x128x128xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x32x128x128xbf16>
    %collapsed_30 = tensor.collapse_shape %78 [[0, 1], [2], [3]] : tensor<1x32x1x128xbf16> into tensor<32x1x128xbf16>
    %collapsed_31 = tensor.collapse_shape %79 [[0, 1], [2], [3]] : tensor<1x32x128x128xbf16> into tensor<32x128x128xbf16>
    %80 = linalg.batch_matmul ins(%collapsed_30, %collapsed_31 : tensor<32x1x128xbf16>, tensor<32x128x128xbf16>) outs(%60 : tensor<32x1x128xbf16>) -> tensor<32x1x128xbf16>
    %expanded_32 = tensor.expand_shape %80 [[0, 1], [2], [3]] output_shape [1, 32, 1, 128] : tensor<32x1x128xbf16> into tensor<1x32x1x128xbf16>
    ...
    %81 = linalg.generic {indexing_maps = [#map, #map1], iterator_types = ["parallel", "parallel", "parallel"]} ins(%collapsed_35 : tensor<4096xbf16>) outs(%1 : tensor<1x1x4096xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x1x4096xbf16>
    %82 = linalg.generic {indexing_maps = [#map2, #map1], iterator_types = ["parallel", "parallel", "parallel"]} ins(%transposed_34 : tensor<4096x4096xbf16>) outs(%3 : tensor<1x4096x4096xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x4096x4096xbf16>
    %83 = linalg.batch_matmul ins(%81, %82 : tensor<1x1x4096xbf16>, tensor<1x4096x4096xbf16>) outs(%5 : tensor<1x1x4096xbf16>) -> tensor<1x1x4096xbf16>
    return %83 : tensor<1x1x4096xbf16>
  }
}
