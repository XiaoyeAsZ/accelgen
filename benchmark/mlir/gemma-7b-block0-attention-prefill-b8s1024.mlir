...
module {
  func.func @main(%arg0: tensor<8x1024x3072xbf16>, %arg1: tensor<1x1024x256xbf16>, %arg2: tensor<1x1024x256xbf16>, %arg3: tensor<1x16x1x1xbf16>, %arg4: tensor<4096x3072xbf16>, %arg5: tensor<4096x3072xbf16>, %arg6: tensor<4096x3072xbf16>, %arg7: tensor<3072x4096xbf16>) -> tensor<8x1024x3072xbf16> {
    ...
    %11 = linalg.generic {indexing_maps = [#map2, #map3, #map2], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%transposed_3, %expanded_10 : tensor<8x16x1024x256xbf16>, tensor<1x1x1024x256xbf16>) outs(%6 : tensor<8x16x1024x256xbf16>) {
    ...
    %14 = linalg.generic {indexing_maps = [#map2, #map3, #map2], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%concat, %expanded_11 : tensor<8x16x1024x256xbf16>, tensor<1x1x1024x256xbf16>) outs(%6 : tensor<8x16x1024x256xbf16>) {
    ^bb0(%in: bf16, %in_26: bf16, %out: bf16):
      %51 = arith.mulf %in, %in_26 : bf16
      linalg.yield %51 : bf16
    } -> tensor<8x16x1024x256xbf16>
    ...
    %16 = linalg.generic {indexing_maps = [#map2, #map3, #map2], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%transposed_6, %expanded_10 : tensor<8x16x1024x256xbf16>, tensor<1x1x1024x256xbf16>) outs(%6 : tensor<8x16x1024x256xbf16>) {
    ^bb0(%in: bf16, %in_26: bf16, %out: bf16):
      %51 = arith.mulf %in, %in_26 : bf16
      linalg.yield %51 : bf16
    } -> tensor<8x16x1024x256xbf16>
    ...
    %18 = linalg.generic {indexing_maps = [#map2, #map3, #map2], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%concat_15, %expanded_11 : tensor<8x16x1024x256xbf16>, tensor<1x1x1024x256xbf16>) outs(%6 : tensor<8x16x1024x256xbf16>) {
    ^bb0(%in: bf16, %in_26: bf16, %out: bf16):
      %51 = arith.mulf %in, %in_26 : bf16
      linalg.yield %51 : bf16
    } -> tensor<8x16x1024x256xbf16>
    ...
    return %50 : tensor<8x1024x3072xbf16>
  }
}
