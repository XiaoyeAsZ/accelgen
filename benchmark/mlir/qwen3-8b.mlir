...
#map5 = affine_map<(d0, d1, d2, d3) -> (0, 0, 0, d3)>
...
module {
  func.func @main(%arg0: tensor<8x1024x4096xbf16>, %arg1: tensor<1x1x128xbf16>, %arg2: tensor<1x1x128xbf16>, %arg3: tensor<1x32x1x1xbf16>, %arg4: tensor<4096x4096xbf16>, %arg5: tensor<1024x4096xbf16>, %arg6: tensor<1024x4096xbf16>, %arg7: tensor<4096x4096xbf16>, %arg8: tensor<128xbf16>, %arg9: tensor<128xbf16>) -> (tensor<8x1024x4096xbf16>, tensor<8x32x1024x1024xbf16>) {
    ...
    %42 = linalg.generic {indexing_maps = [#map2, #map5, #map2], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%transposed_5, %expanded_12 : tensor<8x32x1024x128xbf16>, tensor<1x1x1x128xbf16>) outs(%19 : tensor<8x32x1024x128xbf16>) {
    ^bb0(%in: bf16, %in_29: bf16, %out: bf16):
      %81 = arith.mulf %in, %in_29 : bf16
      linalg.yield %81 : bf16
    ...
    %45 = linalg.generic {indexing_maps = [#map2, #map5, #map2], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%concat, %expanded_13 : tensor<8x32x1024x128xbf16>, tensor<1x1x1x128xbf16>) outs(%19 : tensor<8x32x1024x128xbf16>) {
    ^bb0(%in: bf16, %in_29: bf16, %out: bf16):
      %81 = arith.mulf %in, %in_29 : bf16
      linalg.yield %81 : bf16
    } -> tensor<8x32x1024x128xbf16>
    ...
    %47 = linalg.generic {indexing_maps = [#map2, #map5, #map2], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%transposed_8, %expanded_12 : tensor<8x8x1024x128xbf16>, tensor<1x1x1x128xbf16>) outs(%39 : tensor<8x8x1024x128xbf16>) {
    ^bb0(%in: bf16, %in_29: bf16, %out: bf16):
      %81 = arith.mulf %in, %in_29 : bf16
      linalg.yield %81 : bf16
    ...
    %50 = linalg.generic {indexing_maps = [#map2, #map5, #map2], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%concat_17, %expanded_13 : tensor<8x8x1024x128xbf16>, tensor<1x1x1x128xbf16>) outs(%39 : tensor<8x8x1024x128xbf16>) {
    ^bb0(%in: bf16, %in_29: bf16, %out: bf16):
      %81 = arith.mulf %in, %in_29 : bf16
      linalg.yield %81 : bf16
    } -> tensor<8x8x1024x128xbf16>
    ...
    return %80, %75 : tensor<8x1024x4096xbf16>, tensor<8x32x1024x1024xbf16>
  }
}
