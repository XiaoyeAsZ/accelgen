...
module {
  func.func @main(%arg0: tensor<1x256x3072xbf16>, %arg1: tensor<24576x3072xbf16>, %arg2: tensor<24576x3072xbf16>, %arg3: tensor<3072x24576xbf16>) -> tensor<1x256x3072xbf16> {
    ...
    %5 = tensor.empty() : tensor<1x256x24576xbf16>
    %6 = linalg.fill ins(%cst : bf16) outs(%5 : tensor<1x256x24576xbf16>) -> tensor<1x256x24576xbf16>
    %7 = linalg.batch_matmul ins(%2, %4 : tensor<1x256x3072xbf16>, tensor<1x3072x24576xbf16>) outs(%6 : tensor<1x256x24576xbf16>) -> tensor<1x256x24576xbf16>
    %8 = linalg.generic {indexing_maps = [#map1, #map1], iterator_types = ["parallel", "parallel", "parallel"]} ins(%7 : tensor<1x256x24576xbf16>) outs(%5 : tensor<1x256x24576xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
    ...
    %10 = linalg.batch_matmul ins(%2, %9 : tensor<1x256x3072xbf16>, tensor<1x3072x24576xbf16>) outs(%6 : tensor<1x256x24576xbf16>) -> tensor<1x256x24576xbf16>
    %11 = linalg.generic {indexing_maps = [#map1, #map1, #map1], iterator_types = ["parallel", "parallel", "parallel"]} ins(%8, %10 : tensor<1x256x24576xbf16>, tensor<1x256x24576xbf16>) outs(%5 : tensor<1x256x24576xbf16>) {
    ...
    %collapsed_5 = tensor.collapse_shape %11 [[0, 1], [2]] : tensor<1x256x24576xbf16> into tensor<256x24576xbf16>
    %13 = linalg.generic {indexing_maps = [#map, #map1], iterator_types = ["parallel", "parallel", "parallel"]} ins(%collapsed_5 : tensor<256x24576xbf16>) outs(%5 : tensor<1x256x24576xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x256x24576xbf16>
    ...
    %16 = linalg.fill ins(%cst : bf16) outs(%1 : tensor<1x256x3072xbf16>) -> tensor<1x256x3072xbf16>
    %17 = linalg.batch_matmul ins(%13, %15 : tensor<1x256x24576xbf16>, tensor<1x24576x3072xbf16>) outs(%16 : tensor<1x256x3072xbf16>) -> tensor<1x256x3072xbf16>
    return %17 : tensor<1x256x3072xbf16>
  }
}
