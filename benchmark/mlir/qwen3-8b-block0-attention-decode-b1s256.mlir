...
module {
  func.func @main(%arg0: tensor<1x1x4096xbf16>, %arg1: tensor<1x1x128xbf16>, %arg2: tensor<1x1x128xbf16>, %arg3: tensor<1x32x1x1xbf16>, %arg4: tensor<1x8x255x128xbf16>, %arg5: tensor<1x8x255x128xbf16>, %arg6: tensor<4096x4096xbf16>, %arg7: tensor<1024x4096xbf16>, %arg8: tensor<1024x4096xbf16>, %arg9: tensor<4096x4096xbf16>, %arg10: tensor<128xbf16>, %arg11: tensor<128xbf16>) -> tensor<1x1x4096xbf16> {
    ...
    %concat_18 = tensor.concat dim(2) %arg4, %52 : (tensor<1x8x255x128xbf16>, tensor<1x8x1x128xbf16>) -> tensor<1x8x256x128xbf16>
    %concat_19 = tensor.concat dim(2) %arg5, %transposed_11 : (tensor<1x8x255x128xbf16>, tensor<1x8x1x128xbf16>) -> tensor<1x8x256x128xbf16>
    %53 = tensor.empty() : tensor<1x8x4x256x128xbf16>
    %54 = linalg.generic {indexing_maps = [#map7, #map8], iterator_types = ["parallel", "parallel", "parallel", "parallel", "parallel"]} ins(%concat_18 : tensor<1x8x256x128xbf16>) outs(%53 : tensor<1x8x4x256x128xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x8x4x256x128xbf16>
    %collapsed_20 = tensor.collapse_shape %54 [[0], [1, 2], [3], [4]] : tensor<1x8x4x256x128xbf16> into tensor<1x32x256x128xbf16>
    %55 = linalg.generic {indexing_maps = [#map7, #map8], iterator_types = ["parallel", "parallel", "parallel", "parallel", "parallel"]} ins(%concat_19 : tensor<1x8x256x128xbf16>) outs(%53 : tensor<1x8x4x256x128xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x8x4x256x128xbf16>
    %56 = tensor.empty() : tensor<1x32x128x256xbf16>
    %transposed_21 = linalg.transpose ins(%collapsed_20 : tensor<1x32x256x128xbf16>) outs(%56 : tensor<1x32x128x256xbf16>) permutation = [0, 1, 3, 2] 
    ...
    %collapsed_23 = tensor.collapse_shape %transposed_21 [[0, 1], [2], [3]] : tensor<1x32x128x256xbf16> into tensor<32x128x256xbf16>
    %58 = linalg.generic {indexing_maps = [#map10, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%collapsed_23 : tensor<32x128x256xbf16>) outs(%56 : tensor<1x32x128x256xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x32x128x256xbf16>
    %collapsed_24 = tensor.collapse_shape %57 [[0, 1], [2], [3]] : tensor<1x32x1x128xbf16> into tensor<32x1x128xbf16>
    %collapsed_25 = tensor.collapse_shape %58 [[0, 1], [2], [3]] : tensor<1x32x128x256xbf16> into tensor<32x128x256xbf16>
    %59 = tensor.empty() : tensor<32x1x256xbf16>
    %60 = linalg.fill ins(%cst : bf16) outs(%59 : tensor<32x1x256xbf16>) -> tensor<32x1x256xbf16>
    %61 = linalg.batch_matmul ins(%collapsed_24, %collapsed_25 : tensor<32x1x128xbf16>, tensor<32x128x256xbf16>) outs(%60 : tensor<32x1x256xbf16>) -> tensor<32x1x256xbf16>
    %expanded_26 = tensor.expand_shape %61 [[0, 1], [2], [3]] output_shape [1, 32, 1, 256] : tensor<32x1x256xbf16> into tensor<1x32x1x256xbf16>
    %62 = tensor.empty() : tensor<1x32x1x256xbf16>
    %63 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%expanded_26 : tensor<1x32x1x256xbf16>) outs(%62 : tensor<1x32x1x256xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      %88 = arith.truncf %cst_2 : f64 to bf16
      %89 = arith.mulf %in, %88 : bf16
      linalg.yield %89 : bf16
    } -> tensor<1x32x1x256xbf16>
    %64 = linalg.generic {indexing_maps = [#map3, #map4, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%63, %arg3 : tensor<1x32x1x256xbf16>, tensor<1x32x1x1xbf16>) outs(%62 : tensor<1x32x1x256xbf16>) {
    ^bb0(%in: bf16, %in_36: bf16, %out: bf16):
      %88 = arith.addf %in, %in_36 : bf16
      linalg.yield %88 : bf16
    } -> tensor<1x32x1x256xbf16>
    %65 = tensor.empty() : tensor<1x32x1x256xf32>
    %66 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%64 : tensor<1x32x1x256xbf16>) outs(%65 : tensor<1x32x1x256xf32>) {
    ^bb0(%in: bf16, %out: f32):
      %88 = arith.extf %in : bf16 to f32
      linalg.yield %88 : f32
    ...
    %71:2 = linalg.generic {indexing_maps = [#map3, #map11, #map11], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%66 : tensor<1x32x1x256xf32>) outs(%70, %68 : tensor<1x32x1xf32>, tensor<1x32x1xi64>) {
    ...
    %72 = linalg.generic {indexing_maps = [#map3, #map4, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%66, %expanded_27 : tensor<1x32x1x256xf32>, tensor<1x32x1x1xf32>) outs(%65 : tensor<1x32x1x256xf32>) {
    ^bb0(%in: f32, %in_36: f32, %out: f32):
      %88 = arith.subf %in, %in_36 : f32
      linalg.yield %88 : f32
    } -> tensor<1x32x1x256xf32>
    %73 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%72 : tensor<1x32x1x256xf32>) outs(%65 : tensor<1x32x1x256xf32>) {
    ^bb0(%in: f32, %out: f32):
      %88 = math.exp %in : f32
      linalg.yield %88 : f32
    } -> tensor<1x32x1x256xf32>
    ...
    %76 = linalg.generic {indexing_maps = [#map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%73 : tensor<1x32x1x256xf32>) outs(%75 : tensor<1x32x1x1xf32>) {
    ^bb0(%in: f32, %out: f32):
      %88 = arith.addf %in, %out : f32
      linalg.yield %88 : f32
    } -> tensor<1x32x1x1xf32>
    %77 = linalg.generic {indexing_maps = [#map3, #map4, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%73, %76 : tensor<1x32x1x256xf32>, tensor<1x32x1x1xf32>) outs(%65 : tensor<1x32x1x256xf32>) {
    ^bb0(%in: f32, %in_36: f32, %out: f32):
      %88 = arith.divf %in, %in_36 : f32
      linalg.yield %88 : f32
    } -> tensor<1x32x1x256xf32>
    %78 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%77 : tensor<1x32x1x256xf32>) outs(%62 : tensor<1x32x1x256xbf16>) {
    ^bb0(%in: f32, %out: bf16):
      %88 = arith.truncf %in : f32 to bf16
      linalg.yield %88 : bf16
    } -> tensor<1x32x1x256xbf16>
    %collapsed_28 = tensor.collapse_shape %78 [[0, 1, 2], [3]] : tensor<1x32x1x256xbf16> into tensor<32x256xbf16>
    %79 = linalg.generic {indexing_maps = [#map9, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%collapsed_28 : tensor<32x256xbf16>) outs(%62 : tensor<1x32x1x256xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x32x1x256xbf16>
    %80 = tensor.empty() : tensor<1x32x256x128xbf16>
    %collapsed_29 = tensor.collapse_shape %55 [[0, 1, 2], [3], [4]] : tensor<1x8x4x256x128xbf16> into tensor<32x256x128xbf16>
    %81 = linalg.generic {indexing_maps = [#map10, #map3], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%collapsed_29 : tensor<32x256x128xbf16>) outs(%80 : tensor<1x32x256x128xbf16>) {
    ^bb0(%in: bf16, %out: bf16):
      linalg.yield %in : bf16
    } -> tensor<1x32x256x128xbf16>
    %collapsed_30 = tensor.collapse_shape %79 [[0, 1], [2], [3]] : tensor<1x32x1x256xbf16> into tensor<32x1x256xbf16>
    %collapsed_31 = tensor.collapse_shape %81 [[0, 1], [2], [3]] : tensor<1x32x256x128xbf16> into tensor<32x256x128xbf16>
    %82 = tensor.empty() : tensor<32x1x128xbf16>
    %83 = linalg.fill ins(%cst : bf16) outs(%82 : tensor<32x1x128xbf16>) -> tensor<32x1x128xbf16>
    %84 = linalg.batch_matmul ins(%collapsed_30, %collapsed_31 : tensor<32x1x256xbf16>, tensor<32x256x128xbf16>) outs(%83 : tensor<32x1x128xbf16>) -> tensor<32x1x128xbf16>
