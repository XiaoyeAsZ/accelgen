...
module {
  func.func @main(%arg0: tensor<1x1x4096xbf16>, %arg1: tensor<14336x4096xbf16>, %arg2: tensor<14336x4096xbf16>, %arg3: tensor<4096x14336xbf16>) -> tensor<1x1x4096xbf16> {
    ...
    %8 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "reduction", "parallel", "parallel"]} ins(%arg0, %5 : tensor<1x1x4096xbf16>, tensor<1x4096x14336xbf16>) outs(%7 : tensor<1x1x14336xbf16>) {
    ...
    %10 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = ["parallel", "parallel", "parallel"]} ins(%8 : tensor<1x1x14336xbf16>) outs(%9 : tensor<1x1x14336xbf16>) {
    ...
    %12 = linalg.generic {indexing_maps = [#map3, #map3, #map3], iterator_types = ["parallel", "parallel", "parallel"]} ins(%10, %8 : tensor<1x1x14336xbf16>, tensor<1x1x14336xbf16>) outs(%11 : tensor<1x1x14336xbf16>) {
    ^bb0(%in: bf16, %in_4: bf16, %out: bf16):
      %25 = arith.mulf %in, %in_4 : bf16
    ...
    %17 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "reduction", "parallel", "parallel"]} ins(%arg0, %14 : tensor<1x1x4096xbf16>, tensor<1x4096x14336xbf16>) outs(%16 : tensor<1x1x14336xbf16>) {
    ^bb0(%in: bf16, %in_4: bf16, %out: bf16):
      %25 = arith.mulf %in, %in_4 : bf16
      %26 = arith.addf %out, %25 : bf16
      linalg.yield %26 : bf16
    ...
    %19 = linalg.generic {indexing_maps = [#map3, #map3, #map3], iterator_types = ["parallel", "parallel", "parallel"]} ins(%12, %17 : tensor<1x1x14336xbf16>, tensor<1x1x14336xbf16>) outs(%18 : tensor<1x1x14336xbf16>) {
    ^bb0(%in: bf16, %in_4: bf16, %out: bf16):
      %25 = arith.mulf %in, %in_4 : bf16
      linalg.yield %25 : bf16
    } -> tensor<1x1x14336xbf16>
    ...
    %24 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "reduction", "parallel", "parallel"]} ins(%19, %21 : tensor<1x1x14336xbf16>, tensor<1x14336x4096xbf16>) outs(%23 : tensor<1x1x4096xbf16>) {
    ^bb0(%in: bf16, %in_4: bf16, %out: bf16):
      %25 = arith.mulf %in, %in_4 : bf16
      %26 = arith.addf %out, %25 : bf16
      linalg.yield %26 : bf16
